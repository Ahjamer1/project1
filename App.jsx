  ...
  // Enhanced Sign Up Page with theme support
  const SignUpPage = () => {
  ...
  // Enhanced Sign In Page with theme support
  const SignInPage = () => {
    const { isDark } = useContext(ThemeContext);
    const [formData, setFormData] = useState({
      email: "",
  ...
  export default App; // Enhanced Categories Page with theme support
  ...
  // Enhanced Category Detail Page with theme support
  ...
  // Enhanced Course Page with all new features and theme support
  const CoursePage = () => {
    const { isDark } = useContext(ThemeContext);
  ...
  // Enhanced Dashboard Page with theme support
  const DashboardPage = () => {
    const { isDark } = useContext(ThemeContext);
  ...
  // Enhanced Completion Animation Component with smoother transitions
  ...
  // Enhanced Navbar Component with theme toggle and groups menu
  const Navbar = () => {
  ...
  // Enhanced Home Page with multiple sections and footer
  const HomePage = () => {
    const { isDark } = useContext(ThemeContext);
  ...
  const CustomVideoControls = ({
    ...
    return (
      <div
        ...
        } bg-opacity-80 backdrop-blur-sm p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300`}
      >
        {/* Progress Bar */}
        <div className="mb-4">
          <div
          ...
          >
            <div
              className="h-1 bg-red-600 rounded-full relative"
            ...
            <div className="relative">
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
                    d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.617.789L4.674 14H2a1 1 0 01-1-1V7a1 1 0 011-1h2.674l3.709-2.789a1 1 0 011.617.789zM18 10a8.024 8.024 0 01-1.789 5.035l-1.414-1.414A6.002 6.002 0 0016 10a6.002 6.002 0 00-1.203-3.621l1.414-1.414A8.024 8.024 0 0118 10z"
                    clipRule="evenodd"
                  />
                </svg>
              </button>
  ...
  // Enhanced Video Player with custom controls and quality selection
  ...
  // Professional Video Player Component (keeping original for compatibility)
  const VideoPlayer = ({
    url,
    onProgress,
    onVideoEnd,
    ...
    const handleProgress = (progress) => {
      ...
      // Auto-complete when reaching last 20 seconds
      if (
        duration > 0 &&
        duration - progress.playedSeconds <= 20 &&
        !isCompleted
  ...
  // Futuristic Theme Toggle Component
